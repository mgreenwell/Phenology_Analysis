...
with(site.list.year, boxplot(daynum.tenth~year,xlab="Year",ylab="Flight Period Start Day"))
...
t.test(site.list.year$daynum.tenth~site.list.year$year,paired=TRUE)
