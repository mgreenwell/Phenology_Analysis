...
with(site.list.year, boxplot(daynum.range~year,xlab="Year",ylab="Flight Period Range (Days)"))
...
t.test(site.list.year$daynum.range~site.list.year$year,paired=TRUE)
