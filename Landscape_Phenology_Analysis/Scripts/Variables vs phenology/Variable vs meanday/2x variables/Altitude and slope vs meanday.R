...
library(lme4)
model<-lmer(daynum.mean~DEM_MEAN.SLOPE+year+(1|site),phenology.gis)

# (1|site) gives site as random effect- not a factor of interest
summary(model)
names(phenology.gis)
par(mfrow=c(1,1))
with(phenology.gis, boxplot(daynum.mean~DEM_MEAN.SLOPE))
...
#Testing whether DEM_MEAN.SLOPE has an effect on daynum.mean by comparing with a model that just looks at daynum.mean vs year with site as random effect
...
levels(phenology.gis$DEM_MEAN.SLOPE2)
model2<-lmer(daynum.mean~DEM_MEAN.SLOPE2+year+(1|site),phenology.gis)
anova(model,model2)
...
levels(phenology.gis$DEM_MEAN.SLOPE3)
model3<-lmer(daynum.mean~DEM_MEAN.SLOPE3+year+(1|site),phenology.gis)
anova(model,model3)
...
levels(phenology.gis$DEM_MEAN.SLOPE4)
model4<-lmer(daynum.mean~DEM_MEAN.SLOPE4+year+(1|site),phenology.gis)
anova(model3,model4)
...
levels(phenology.gis$DEM_MEAN.SLOPE5)
model5<-lmer(daynum.mean~DEM_MEAN.SLOPE5+year+(1|site),phenology.gis)
anova(model3,model5)
...
levels(phenology.gis$DEM_MEAN.SLOPE6)
model6<-lmer(daynum.mean~DEM_MEAN.SLOPE6+year+(1|site),phenology.gis)
anova(model3,model6)
...
levels(phenology.gis$DEM_MEAN.SLOPE7)
model7<-lmer(daynum.mean~DEM_MEAN.SLOPE7+year+(1|site),phenology.gis)
anova(model3,model7)
...
levels(phenology.gis$DEM_MEAN.SLOPE8)
model8<-lmer(daynum.mean~DEM_MEAN.SLOPE8+year+(1|site),phenology.gis)
anova(model3,model8)
...
levels(phenology.gis$DEM_MEAN.SLOPE9)
model9<-lmer(daynum.mean~DEM_MEAN.SLOPE9+year+(1|site),phenology.gis)
anova(model3,model9)
...
levels(phenology.gis$DEM_MEAN.SLOPE10)
model10<-lmer(daynum.mean~DEM_MEAN.SLOPE10+year+(1|site),phenology.gis)
...
levels(phenology.gis$DEM_MEAN.SLOPE11)
model11<-lmer(daynum.mean~DEM_MEAN.SLOPE11+year+(1|site),phenology.gis)
...
levels(phenology.gis$DEM_MEAN.SLOPE12)
model12<-lmer(daynum.mean~DEM_MEAN.SLOPE12+year+(1|site),phenology.gis)
...
levels(phenology.gis$DEM_MEAN.SLOPE13)
model13<-lmer(daynum.mean~DEM_MEAN.SLOPE13+year+(1|site),phenology.gis)
...
levels(phenology.gis$DEM_MEAN.SLOPE14)
model14<-lmer(daynum.mean~DEM_MEAN.SLOPE14+year+(1|site),phenology.gis)
...
with(phenology.gis, boxplot(daynum.mean~DEM_MEAN.SLOPE9,xlab="Site type",ylab="daynum.mean",ylim = c(0, 200)))
...
p<-ggplot(phenology.gis,aes(x=DEM_MEAN.SLOPE9,y=daynum.mean))+geom_violin(fill="grey",col="black")+theme_minimal()
