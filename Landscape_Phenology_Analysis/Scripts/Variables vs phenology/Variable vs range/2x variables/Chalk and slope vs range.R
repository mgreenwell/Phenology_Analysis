...
model<-lmer(daynum.range~LC.SLOPE+year+(1|site),phenology.gis)

# (1|site) gives site as random effect- not a factor of interest
summary(model)

#with(phenology.gis, boxplot(daynum.range~LC.SLOPE,ylim = c(0, 130)))
...
levels(phenology.gis$LC.SLOPE2)
model2<-lmer(daynum.range~LC.SLOPE2+year+(1|site),phenology.gis)
anova(model,model2)
###### 
...
levels(phenology.gis$LC.SLOPE3)
model3<-lmer(daynum.range~LC.SLOPE3+year+(1|site),phenology.gis)
anova(model2,model3)
...
levels(phenology.gis$LC.SLOPE4)
model4<-lmer(daynum.range~LC.SLOPE4+year+(1|site),phenology.gis)
anova(model2,model4)
...
levels(phenology.gis$LC.SLOPE5)
model5<-lmer(daynum.range~LC.SLOPE5+year+(1|site),phenology.gis)
anova(model2,model5)
...
levels(phenology.gis$LC.SLOPE6)
model6<-lmer(daynum.range~LC.SLOPE6+year+(1|site),phenology.gis)
anova(model2,model6)
...
levels(phenology.gis$LC.SLOPE7)
model7<-lmer(daynum.range~LC.SLOPE7+year+(1|site),phenology.gis)
anova(model2,model7)
...
levels(phenology.gis$LC.SLOPE8)
model8<-lmer(daynum.range~LC.SLOPE8+year+(1|site),phenology.gis)
anova(model2,model8)
...
levels(phenology.gis$LC.SLOPE9)
model9<-lmer(daynum.range~LC.SLOPE9+year+(1|site),phenology.gis)
anova(model2,model9)
...
levels(phenology.gis$LC.SLOPE10)
model10<-lmer(daynum.range~LC.SLOPE10+year+(1|site),phenology.gis)
...
levels(phenology.gis$LC.SLOPE11)
model11<-lmer(daynum.range~LC.SLOPE11+year+(1|site),phenology.gis)
...
levels(phenology.gis$LC.SLOPE12)
model12<-lmer(daynum.range~LC.SLOPE12+year+(1|site),phenology.gis)
...
levels(phenology.gis$LC.SLOPE13)
model13<-lmer(daynum.range~LC.SLOPE13+year+(1|site),phenology.gis)
...
levels(phenology.gis$LC.SLOPE14)
model14<-lmer(daynum.range~LC.SLOPE14+year+(1|site),phenology.gis)
anova(model2,model14)

##########   have shown that simplest model is model 2#########
#with(phenology.gis, boxplot(daynum.range~LC.SLOPE2,xlab="Site type",
